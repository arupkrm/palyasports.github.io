...
<!-- Mirrored from dev.playasport.in/deletion-policy by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 06 Dec 2024 10:17:52 GMT -->
...
<div class="orange-container">
            <div class="container">
                <div class="user-agreement-page contact-page ">
                    <h1 class="text-center">  Data Deletion Policy Summary </h1>
                    <div class="agreement">
                        <div style="font-size: 18px;">
        <ol>
            <li>Play a sport provides users with full control over their data, including what data is retained and what data is deleted.</li>
            <li>End users can request all or part of their data to be deleted by sending an email to admin@playasport.in. Once the request is approved by their company, we will delete their data.</li>
            <li>Enterprise customers can request data to be deleted for all or some of their users.</li>
            <li>The request can be initiated by sending an email to admin@playasport.in with details of the data deletion request (type of data to delete, users to delete, time frame of deletion, etc).</li>
        </ol>
    </div>
                    </div>
                </div>
