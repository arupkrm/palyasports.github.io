...
<!-- Mirrored from dev.playasport.in/contact by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 06 Dec 2024 10:17:43 GMT -->
            ...
            <div class="contact-page-content">
                <div class=" mail-number">
                    <div class="">
                        <h3 class="">Email :</h3>
                        <div class="  ">
                            <a href="mailto:admin@playasport.in">
                                <div class="mail d-flex align-items-center">
                                    <i class="fa-regular fa-envelope"></i>
                                    <h5>admin@playasport.in</h5>
                                </div>
                            </a>
                        </div>
                    </div>
                ...
                <div class=" mail-number">
                    <div class="">
                        <h3 class="">Number :</h3>
                        <div class="">
                                                                                                                            <a href="tel:9230981841(12pm to 6pm)">
                                        <div class="mail d-flex align-items-center">
                                            <i class="fa-solid fa-phone"></i>
                                            <h5> 9230981841(12pm to 6pm)</h5>
                                        </div>
                                    </a>
                                                                    <a href="tel:9230981844(12pm to 6pm)">
                                        <div class="mail d-flex align-items-center">
                                            <i class="fa-solid fa-phone"></i>
                                            <h5> 9230981844(12pm to 6pm)</h5>
                                        </div>
                                    </a>
                                                                                    </div>
                    </div>
                ...
                <div class=" mail-number">
                    <div class="">
                        <h3>Address :</h3>
                        <div>
                            <h5>AE-694 Sector 1, Salt Lake City, Bidhan Nagar AE Market, North 24 Parganas, Saltlake, West Bengal, India, 700064</h5>
                        </div>
                    </div>
                </div>
            </div>
