        ...
        let o = function () {
            ...
            f = function (e) {
                return (
                    ...
                    //     }Mb`
                    // ),
                    ($('.message-container').text(`The file "${e.name}" exceeds the maximum size of ${a.settings.maxSize / 1024 / 1024}Mb`),
                        !1)
                );
            },
            m = function (e, t) {
                return (
                    ...
                    ($('.message-container').text(`The file "${t.name}" could not be added because the limit of ${a.settings.maxFiles} files was reached`),
                        !1)
                );
            },
            u = function (t, n) {
