...
<!-- Mirrored from dev.playasport.in/about by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 06 Dec 2024 10:17:43 GMT -->
...
<!-- Let's Connect Offcanvas Ends -->
    ...
    <div class="container">
        <div class="about-page">
            <div class="row">
                <div class="col-md-6 ">
                    <h1 class="text-center text-md-start wow fadeInDown">About Us</h1>
                    <p class="text-center text-md-start wow fadeInUp"><p><span style="color: rgb(255, 255, 255); font-family: &quot;Atyp Display&quot;; font-size: 16px; background-color: rgb(239, 72, 35);">Play A Sport is an initiative to amalgamate Sports with Technology and create an online platform to build more room for the sports community. Play A Sport will be an application through which a user will be able to access a Sport of his/her choice and be able to play/learn the same.</span><br></p></p>
                </div>
                <div class="col-md-6">
                    <div data-wow-offset="400" class="about-page-screen wow fadeIn d-flex justify-content-center">
                        <div class="mobile-frame">
                            <div class="screenshot-bg-circle"></div>
                            <div class="screen-shot">
                                <img class="img-fluid" src="frontend/images/about-page-animation.gif" alt=""> 
                            </div>
                        </div>
                    </div>
                </div>
